##
## Implementation constraints for the DelayLine.v Verilog example.
...
## slide switches
set_property -dict { PACKAGE_PIN A8   IOSTANDARD LVCMOS33 } [get_ports { DelaySelect[0] }] ;   ## SW0
set_property -dict { PACKAGE_PIN C11  IOSTANDARD LVCMOS33 } [get_ports { DelaySelect[1] }] ;   ## SW1
set_property -dict { PACKAGE_PIN C10  IOSTANDARD LVCMOS33 } [get_ports { DelaySelect[2] }] ;   ## SW2
...
## auxiliary PWM output for test purposes
set_property -dict { PACKAGE_PIN F5  IOSTANDARD LVCMOS33 } [get_ports PWM] ;   ## A0
...
set_input_delay -clock clk100 2.000 [get_ports SignalIn]

## disable timing checks for static MUX selection pins
#set_false_path -from [get_ports DelaySelect*] -to [SignalOut]
