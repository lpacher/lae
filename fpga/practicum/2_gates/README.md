...
Finally **program the FPGA** using the Vivado _Hardware Manager_ as discussed in the introductory practicum
...
Feel free to use **Python** and **PyROOT** scripts instead of C/C++ macros:

```
cp ../../../sample/ROOT/plotDataArray.py .
```
