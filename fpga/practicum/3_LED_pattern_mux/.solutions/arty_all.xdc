##
## This file is the complete .xdc for Digilent Arty / Arty A7 development board.
## It can be also downloaded from Digilent GitHub repository at:
##
...
##
## To use these constraints in a project:
##
##    - uncomment the lines corresponding to used pins
##    - rename the used ports (in each line, after get_ports) according to the top level signal names in the project
##
## To find actual physical locations of pins on the board, please check Arty/Arty A7 reference board schematics:
##
