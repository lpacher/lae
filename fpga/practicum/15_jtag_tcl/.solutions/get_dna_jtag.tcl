...
## shift-in the FUSE_DNA instruction (binary 110010 for standard AMD/Xilinx FPGAs)
scan_ir_hw_jtag 6 -tdi 32

## restart from IDLE
run_state_hw_jtag IDLE

## shift-in 64 bits of TDI dummy data to clock-out the 64-bits FUSE_DNA on the TDO line
