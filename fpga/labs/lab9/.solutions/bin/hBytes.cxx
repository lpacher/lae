//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Simple ROOT macro to plot the "trend" of bytes generated by an 8-bit Linear-Feedback
...
//   % root bin/hBytes.cxx
//
// By default the macro assumes to process "work/sim/LFSR.txt", but you can also start ROOT
...
void hBytes (char *fileName="work/sim/LFSR.txt") {
   ...
   gStyle->SetOptStat(0) ;   // don't show the statistics box by default
