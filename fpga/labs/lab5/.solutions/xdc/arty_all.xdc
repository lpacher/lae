##
## This file is the complete .xdc for the Digilent ARTY Rev. B development board
...
##
## To find actual physical locations of pins on the board, please check Arty reference board schematics
##
